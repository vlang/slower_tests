...
const scrypt_test_cases = [
	// test longer running reference test vectors.
	// test case 1 is in the unit test for scrypt in vlang/v
	ScryptTestData{
		name:            'test case 2'
		...
		p:               16
		dk_len:          64
		expected_result: [u8(0xfd), 0xba, 0xbe, 0x1c, 0x9d, 0x34, 0x72, 0x00, 0x78, 0x56, 0xe7,
	...
	ScryptTestData{
		name:            'test case 3'
		password:        'pleaseletmein'.bytes()
		salt:            'SodiumChloride'.bytes()
		n:               16384
		r:               8
		p:               1
		dk_len:          64
		expected_result: [u8(0x70), 0x23, 0xbd, 0xcb, 0x3a, 0xfd, 0x73, 0x48, 0x46, 0x1c, 0x06,
	...
	ScryptTestData{
		...
		p:               1
		dk_len:          64
		expected_result: [u8(0x21), 0x01, 0xcb, 0x9b, 0x6a, 0x51, 0x1a, 0xae, 0xad, 0xdb, 0xbe,
...
fn test_scrypt() {
	for c in scrypt_test_cases {
		results := scrypt.scrypt(c.password, c.salt, c.n, c.r, c.p, c.dk_len)!
